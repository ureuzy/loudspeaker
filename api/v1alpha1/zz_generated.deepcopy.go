...
func (in Ignores) DeepCopyInto(out *Ignores) {
	{
		in := &in
		*out = make(Ignores, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Ignores.
func (in Ignores) DeepCopy() Ignores {
	if in == nil {
		return nil
	}
	out := new(Ignores)
