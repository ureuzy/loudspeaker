...
func (in IgnoreEventTypes) DeepCopyInto(out *IgnoreEventTypes) {
	{
		in := &in
		*out = make(IgnoreEventTypes, len(*in))
		copy(*out, *in)
	}
}
...
func (in IgnoreObjectKinds) DeepCopyInto(out *IgnoreObjectKinds) {
	{
		in := &in
		*out = make(IgnoreObjectKinds, len(*in))
		copy(*out, *in)
	}
}
...
func (in IgnoreObjectNames) DeepCopyInto(out *IgnoreObjectNames) {
	{
		in := &in
		*out = make(IgnoreObjectNames, len(*in))
		copy(*out, *in)
	}
}
...
func (in *Observe) DeepCopyInto(out *Observe) {
	*out = *in
	...
	if in.IgnoreObjectNames != nil {
		in, out := &in.IgnoreObjectNames, &out.IgnoreObjectNames
		*out = make(IgnoreObjectNames, len(*in))
		copy(*out, *in)
	}
	if in.IgnoreObjectKinds != nil {
		in, out := &in.IgnoreObjectKinds, &out.IgnoreObjectKinds
		*out = make(IgnoreObjectKinds, len(*in))
		copy(*out, *in)
	}
	if in.IgnoreEventTypes != nil {
		in, out := &in.IgnoreEventTypes, &out.IgnoreEventTypes
		*out = make(IgnoreEventTypes, len(*in))
		copy(*out, *in)
	}
}
